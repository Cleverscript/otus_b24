...
$MESS['OTUS_CRM_ACTIVITI_COMP_CREATE_SUCCESS'] = 'Создана комания #NAME# ##ID# и прикреплена к заказу #ORDER_ID#';
$MESS['SEARCHBYINN_ACTIVITY_DOC_ID_NULL'] = 'Не определен ID документа (заказа)';
$MESS[''] = '';